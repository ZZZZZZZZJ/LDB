...
%Input Parameter
%InputDir        =   './data/fall/img/';
%OutputDir       =   './data/fall/fpcp/'
InputDir = '/home/iprai/zzj/CD/dataset/dataset2014/dataset/dynamicBackground/canoe/input/';
MaskDir  = '/home/iprai/zzj/CD/dataset/dataset2014/dataset/dynamicBackground/canoe/groundtruth/'
numFrame = 201;
start_frame = 800;
OutputDir = './test_data/canoe/'
Mode            =   'FPCP'%AVG,RPCA
