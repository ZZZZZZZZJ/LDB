function [LowRank,Mask,tau,info,E,C] = ObjDetection_LDB(ImData,CNNData,MaskData,opt)
%function [LowRank,Mask,tau,info,E,C] = ObjDetection_DECOLOR(ImData,CNNData,EdgeData,MaskData,opt)
